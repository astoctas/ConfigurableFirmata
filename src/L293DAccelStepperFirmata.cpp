...
#include "L293DAccelStepperFirmata.h"
#include "utility/AccelStepper.h"
#include "utility/MultiStepper.h"

boolean L293DAccelStepperFirmata::handlePinMode(byte pin, int mode)
{
...
void L293DAccelStepperFirmata::handleCapability(byte pin)
{
  if (IS_PIN_DIGITAL(pin)) {
...
void L293DAccelStepperFirmata::reportPosition(byte deviceNum, bool complete)
{
...
void L293DAccelStepperFirmata::reportGroupComplete(byte deviceNum)
{
  if (group[deviceNum]) {
    Firmata.write(START_SYSEX);
    Firmata.write(ACCELSTEPPER_DATA);
...
boolean L293DAccelStepperFirmata::handleSysex(byte command, byte argc, byte *argv)
{
...
void L293DAccelStepperFirmata::reset()
{
...
float L293DAccelStepperFirmata::decodeCustomFloat(byte arg1, byte arg2, byte arg3, byte arg4)
{
  long l4 = (long)arg4;
...
long L293DAccelStepperFirmata::decode32BitSignedInteger(byte arg1, byte arg2, byte arg3, byte arg4, byte arg5)
{
...
void L293DAccelStepperFirmata::encode32BitSignedInteger(long value, byte pdata[])
{
  bool inv = false;
 ...
 * LOOP()
 *============================================================================*/
void L293DAccelStepperFirmata::update()
{
  bool stepsLeft;
